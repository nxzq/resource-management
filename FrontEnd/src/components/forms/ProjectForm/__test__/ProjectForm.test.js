...
describe('Input Fields', () => {
  ...
  it('Name Input triggers handleProjectChange onChange', async () => {
    const {queryByPlaceholderText} = render(<ProjectForm handleProjectChange={handleProjectChange} />);
  ...
  it('Year Input triggers handleProjectChange onChange', async () => {
    const {queryByTestId} = render(<ProjectForm handleProjectChange={handleProjectChange} />);
...
describe('Remove Button', () => {
  it('Button Removes Project onClick', async () => {
    ...
    const {queryByText} = render(<ProjectForm removeProject={removeProject} />);
