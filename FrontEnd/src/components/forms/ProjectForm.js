        ...
        <div>
            <Row>
                <FormGroup className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <Input required type="text" name="ProjName" id="ProjName" placeholder="Project Name" value={ProjName} onChange={(e) => { handleProjectChange(index, e) }} />
                </FormGroup>
                <FormGroup className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <FormGroup className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <Input required type="text" name="ProjAssociation" id="ProjAssociation" placeholder="Project Association" value={ProjAssociation} onChange={(e) => { handleProjectChange(index, e) }} />
                </FormGroup>
                <FormGroup className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <Label for="ProjInfo">Details</Label>
                    <Input required type="textarea" name="ProjInfo" id="ProjInfo" placeholder="Project Details" value={ProjInfo} onChange={(e) => { handleProjectChange(index, e) }} />
                </FormGroup>
