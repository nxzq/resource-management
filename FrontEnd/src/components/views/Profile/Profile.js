...
export default function Profile(props) {
  ...
  const Education = () => {
    ...
    return resource.Education.length === 0 ? (
    ...
    for (let i = 0; i < resource.Experience.length; i++) {
      Experience = [
        ...
        <div key={Experience.length} className={'col-md-' + width}>
          <p>
            <b>Job Title:</b>&nbsp;{resource.Experience[i].JobTitle}
          </p>
          <p>
            <b>Job Company/Organization:</b>&nbsp;
            {resource.Experience[i].JobOrg}
          </p>
          <p>
            <b>Start Date:</b>&nbsp;{resource.Experience[i].JobStartDate}
          </p>
          {resource.Experience[i].JobEndDate === '' ? (
            <p>
              <b>End Date:</b>&nbsp;Present
            </p>
          ) : (
            <p>
              <b>End Date:</b>&nbsp;{resource.Experience[i].JobEndDate}
            </p>
          )}
          {resource.Experience[i].JobInfo === '' ? (
            ...
            <p>
              <b>Details:</b>&nbsp;{resource.Experience[i].JobInfo}
            </p>
          )}
        </div>,
      ]
    }
    return resource.Experience.length === 0 ? (
      <div className="col-md-12">
        <p>None</p>
      </div>
    ) : (
    ...
    for (let i = 0; i < resource.Project.length; i++) {
      Project = [
        ...
        <div key={Project.length} className={'col-md-' + width}>
          <p>
            <b>Project Name:</b>&nbsp;{resource.Project[i].ProjName}
          </p>
          <p>
            <b>Project Association:</b>&nbsp;
            {resource.Project[i].ProjAssociation}
          </p>
          <p>
            <b>Project Date:</b>&nbsp;{resource.Project[i].ProjDate}
          </p>
          {resource.Project[i].ProjInfo === '' ? (
            ...
            <p>
              <b>Details:</b>&nbsp;{resource.Project[i].ProjInfo}
            </p>
          )}
        </div>,
      ]
    }
    return resource.Project.length === 0 ? (
      <div className="col-md-12">
        <p>None</p>
      </div>
    ) : (
    ...
    for (let i = 0; i < resource.Certification.length; i++) {
      Certification = [
        ...
        <div key={Certification.length} className={'col-md-' + width}>
          <p>
            <b>Certification Name:</b>&nbsp;{resource.Certification[i].CertName}
          </p>
          <p>
            <b>Certification Association:</b>&nbsp;
            {resource.Certification[i].CertAssociation}
          </p>
          <p>
            <b>Certification Date:</b>&nbsp;{resource.Certification[i].CertDate}
          </p>
        </div>,
      ]
    }
    return resource.Certification.length === 0 ? (
      <div className="col-md-12">
        <p>None</p>
      </div>
    ) : (
  ...
  const Skills = () => {
    let skillList = resource.Skills.sort((a, b) =>
            ...
            <div>
              ...
              <Container>
                <Row>
                  ...
                  <p className="col-md-6">
                    <b>Phone:</b>&nbsp;
                    {resource.Phone.length === 10
                      ? `(${resource.Phone.substring(
                          0,
                          resource.Phone.length - 7
                        )})-${resource.Phone.substring(
                          resource.Phone.length - 7,
                          resource.Phone.length - 4
                        )}-${resource.Phone.substring(
                          resource.Phone.length - 4,
                          resource.Phone.length
                        )}`
                      : `+${resource.Phone.substring(
                          0,
                          resource.Phone.length - 10
                ...
                <Row>
                  <Link
                    className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right"
                    style={{ textDecoration: 'none' }}
                    to="/"
                  >
                    <Button
                      ...
                      className="blue-button shadow-none"
                      color="primary"
                    >
                      Return To Resources
                    </Button>
